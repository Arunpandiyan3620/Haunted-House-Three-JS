...
// Add light scenry
const light1 = new THREE.PointLight("#8800ff", 6);
const light2 = new THREE.PointLight("#ff0088", 6);
const light3 = new THREE.PointLight("#ff0000", 6);
...
// Door light helper(testing purpose)
...
const tick = () => {
  ...
  light1.position.y =
    Math.sin(light1Angle * 2.34) * Math.sin(light1Angle * 3.45);

  const light2Angle = -elapsedTime * 0.38;
  light2.position.x = Math.cos(light2Angle) * 5;
  light2.position.z = Math.sin(light2Angle) * 5;
  light2.position.y =
    Math.sin(light2Angle * 2.34) * Math.sin(light2Angle * 3.45);

  const light3Angle = elapsedTime * 0.23;
  light3.position.x = Math.cos(light3Angle) * 6;
  light3.position.z = Math.sin(light3Angle) * 6;
  light3.position.y =
    Math.sin(light3Angle * 2.34) * Math.sin(light3Angle * 3.45);
